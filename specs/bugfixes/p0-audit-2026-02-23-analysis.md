...
**Affected files:**
- `backend/crates/omega-providers/src/tools.rs:352` -- `truncate_output()` uses `&s[..max_chars]`
- `backend/crates/omega-memory/src/audit.rs:91` -- `truncate()` uses `&s[..max]`
- `backend/crates/omega-memory/src/store/context.rs:332` -- inline `&content[..200]`
- `backend/crates/omega-channels/src/telegram/send.rs:161-170` -- `split_message()` byte arithmetic
- `backend/crates/omega-channels/src/whatsapp/send.rs:156` -- `split_message()` byte arithmetic (found during review)
...
**Affected files:**
- `backend/crates/omega-providers/src/openai.rs:41`
- `backend/crates/omega-providers/src/ollama.rs:30`
- `backend/crates/omega-providers/src/anthropic.rs:33`
- `backend/crates/omega-providers/src/openrouter.rs:34`
- `backend/crates/omega-providers/src/gemini.rs:32`
...
**Affected file:** `backend/crates/omega-memory/src/store/messages.rs:77`
