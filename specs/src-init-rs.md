...
| `cliclack::multiselect(label)` | Multi-choice selection with `.item()`, `.required(false)` for optional selection |
...
### Phase 7: Optional Tools (Multiselect with Enter-fallback)
