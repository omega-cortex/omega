...
**Location A:** `backend/crates/omega-providers/src/tools.rs:352-361`
...
**Location B:** `backend/crates/omega-memory/src/audit.rs:87-93`
...
**Location C:** `backend/crates/omega-memory/src/store/context.rs:332`
...
**Location D:** `backend/crates/omega-channels/src/telegram/send.rs:160-170`
...
**Locations:**
- `backend/crates/omega-providers/src/openai.rs:41` -- `reqwest::Client::new()`
- `backend/crates/omega-providers/src/ollama.rs:30` -- `reqwest::Client::new()`
- `backend/crates/omega-providers/src/anthropic.rs:33` -- `reqwest::Client::new()`
- `backend/crates/omega-providers/src/openrouter.rs:34` -- `reqwest::Client::new()`
- `backend/crates/omega-providers/src/gemini.rs:32` -- `reqwest::Client::new()`
...
**Location:** `backend/crates/omega-memory/src/store/messages.rs:66-77`
...
**Location:** `backend/crates/omega-providers/src/gemini.rs:210-213`
...
- `backend/src/gateway/keywords.rs:164`
- `backend/src/commands/tasks.rs:78`
- `backend/crates/omega-memory/src/store/context.rs:12`
...
**Location:** `backend/src/gateway/mod.rs:290`
...
**Location:** `backend/src/gateway/routing.rs`
...
- `backend/crates/omega-memory/src/store/tasks.rs:11` (`create_task` -- 8 params)
- Several gateway functions

### 9. Weekday Skip: Two Separate UPDATE Queries

**Location:** `backend/crates/omega-memory/src/store/tasks.rs:153-173`
...
- **Code:** `backend/src/gateway/mod.rs` -- field does not exist (removed in migration 012)
...
|--------|-----------|---------------|
| Location | `main.rs` | `backend/src/provider_builder.rs` |
...
- **Code:** `backend/crates/omega-core/src/config/mod.rs` (lines 147-168)
...
| `specs/src-markers-rs.md` | `backend/src/markers.rs` | `backend/src/markers/` (7 files) |
| `specs/src-commands-rs.md` | `backend/src/commands.rs` | `backend/src/commands/` (6 files) |
...
### 29. No Spec for `backend/src/provider_builder.rs`
### 30. No Spec for `backend/src/pair.rs`
### 31. No Spec for `backend/src/i18n/` Module (6 files, 450+ lines)
...
| 19 | Create spec for `backend/src/i18n/` module |
