...
- The default system prompt: *"You are Omega, a personal AI assistant running on the user's own server. You are helpful, concise, and action-oriented."*
...
> You are Omega, a personal AI assistant running on the user's own server. You are helpful, concise, and action-oriented.
...
Context {
    system_prompt: "You are Omega, a personal AI assistant...",
    history: [],
...
```
Context {
    system_prompt: "You are Omega, a personal AI assistant running on
