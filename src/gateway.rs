...
// ---------------------------------------------------------------------------
// Generic marker helpers — handle markers both at line start and inline.
// ---------------------------------------------------------------------------
...
fn extract_inline_marker_value(text: &str, prefix: &str) -> Option<String> {
...
fn strip_inline_marker(text: &str, prefix: &str) -> String {
...
fn strip_all_remaining_markers(text: &str) -> String {
    const MARKERS: &[&str] = &[
        "LANG_SWITCH:",
        "PERSONALITY:",
        "CANCEL_TASK:",
