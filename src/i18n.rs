...
pub fn t(key: &str, lang: &str) -> &'static str {
    match key {
        ...
        "heartbeat_header" => match lang {
            "Spanish" => "Heartbeat de *OMEGA Ω*",
            "Portuguese" => "Heartbeat do *OMEGA Ω*",
            "French" => "Heartbeat de *OMEGA Ω*",
            "German" => "*OMEGA Ω* Heartbeat",
            "Italian" => "Heartbeat di *OMEGA Ω*",
            "Dutch" => "*OMEGA Ω* Heartbeat",
            "Russian" => "Heartbeat *OMEGA Ω*",
            _ => "*OMEGA Ω* Heartbeat",
        },
        ...
        "heartbeat_watchlist" => match lang {
            ...
            "French" => "Éléments surveillés:",
            "German" => "Überwachte Einträge:",
            "Italian" => "Elementi monitorati:",
            "Dutch" => "Gemonitorde items:",
            "Russian" => "Отслеживаемые элементы:",
            _ => "Watchlist items:",
        },
        "heartbeat_no_watchlist" => match lang {
            ...
            "French" => "Aucun élément. Configurez ~/.omega/prompts/HEARTBEAT.md",
            "German" => "Keine Einträge. Konfiguriere ~/.omega/prompts/HEARTBEAT.md",
            "Italian" => "Nessun elemento. Configura ~/.omega/prompts/HEARTBEAT.md",
            "Dutch" => "Geen items. Configureer ~/.omega/prompts/HEARTBEAT.md",
            "Russian" => "Нет элементов. Настройте ~/.omega/prompts/HEARTBEAT.md",
            _ => "No watchlist items. Configure ~/.omega/prompts/HEARTBEAT.md",
        },
        "help_heartbeat" => match lang {
            "Spanish" => "/heartbeat — Estado y lista de monitoreo",
            "Portuguese" => "/heartbeat — Estado e lista de monitoramento",
            "French" => "/heartbeat — Statut et liste de surveillance",
            "German" => "/heartbeat — Status und Überwachungsliste",
            "Italian" => "/heartbeat — Stato e lista di monitoraggio",
            "Dutch" => "/heartbeat — Status en bewakingslijst",
            "Russian" => "/heartbeat — Статус и список мониторинга",
            _ => "/heartbeat — Heartbeat status and watchlist",
        },
